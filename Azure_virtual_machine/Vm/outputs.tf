...
output "web_linuxvm_network_interface_id" {
  ...
  value       = azurerm_network_interface.web-linux-nic.id
}
...
output "web_linuxvm_network_interface_private_ip_addresses" {
  ...
  value       = [azurerm_network_interface.web-linux-nic.private_ip_addresses]
}
...
output "web_linuxvm_public_ip_address" {
  ...
  value       = azurerm_linux_virtual_machine.weblinuxvm.public_ip_address
}
...
output "web_linuxvm_private_ip_address" {
  ...
  value       = azurerm_linux_virtual_machine.weblinuxvm.private_ip_address
}
...
output "web_linuxvm_virtual_machine_id_128bit" {
  ...
  value       = azurerm_linux_virtual_machine.weblinuxvm.virtual_machine_id
}
## Virtual Machine ID
output "web_linuxvm_virtual_machine_id" {
  description = "Web Linux Virtual Machine ID "
  value       = azurerm_linux_virtual_machine.weblinuxvm.id
}